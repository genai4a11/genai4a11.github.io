...
const CONCEPT_PAGES={
  ...
  // batch 12 — prompting group
  zero_shot:'concepts/zero-shot.html',
  few_shot:'concepts/few-shot.html',
  system_prompts:'concepts/system-prompts.html',
  role_prompting:'concepts/role-prompting.html',
  zero_cot:'concepts/chain-of-thought.html',
  scratchpad:'concepts/extended-thinking.html',
  self_consist:'concepts/self-consistency.html',
  tot:'concepts/tree-of-thoughts.html',
  react:'concepts/react-prompting.html',
  dspy:'concepts/dspy.html',
  lmql:'concepts/lmql.html',
  prompt_versioning:'concepts/prompt-versioning.html',
  prompt_caching:'concepts/prompt-caching.html',
  json_mode:'concepts/json-mode.html',
  instructor:'concepts/instructor.html',
  code_output_validation:'concepts/code-output-validation.html',
  outlines:'concepts/outlines.html',
  // batch 13 — RAG components
  st_lib:'concepts/sentence-transformers.html',
  oai_emb:'concepts/openai-embeddings.html',
  bge_rag:'concepts/bge-embeddings.html',
  cohere_emb:'concepts/cohere-embeddings.html',
  pinecone:'concepts/pinecone.html',
  chroma:'concepts/chroma.html',
  qdrant:'concepts/qdrant.html',
  pgvector:'concepts/pgvector.html',
  weaviate:'concepts/weaviate.html',
  milvus:'concepts/milvus.html',
  dense_retrieval:'concepts/dense-retrieval.html',
  bm25:'concepts/bm25.html',
  hybrid_search:'concepts/hybrid-search.html',
  hyde:'concepts/hyde.html',
  colbert:'concepts/colbert.html',
  multi_query:'concepts/multi-query-retrieval.html',
  rerank:'concepts/reranking.html',
  ctx_compress:'concepts/context-compression.html',
  // batch 14 — Agents
  react_agent:'concepts/react-agent.html',
  tool_use:'concepts/tool-use.html',
  ...
  // batch 14c — Agents (third wave)
  parallel_agents:'concepts/parallel-execution.html',
  sequential_chain:'concepts/sequential-chain.html',
  tool_selection:'concepts/tool-selection.html',
  code_mode:'concepts/code-mode.html',
  entity_memory:'concepts/entity-memory.html',
  event_driven_agent:'concepts/event-driven-agent.html',
  agent_skills:'concepts/agent-skills.html',
  agentic_reasoning:'concepts/agentic-reasoning.html',
  // batch 14d — Agents (final 3)
  plano:'concepts/plano.html',
  dify:'concepts/dify.html',
  langflow:'concepts/langflow.html',
  // batch 15 — eval(2) + llms(4) + infra(2) + safety(2) + rag(1)
  ragas:'concepts/ragas.html',
  langsmith:'concepts/langsmith.html',
  gpt4o:'concepts/gpt4o.html',
  claude35:'concepts/claude35.html',
  o3:'concepts/o3.html',
  deepseek:'concepts/deepseek-r1.html',
  ollama:'concepts/ollama.html',
  gguf:'concepts/gguf-llamacpp.html',
  ...
  // batch 17 — infra(5) + eval(4) + multimodal(1)
  tgi:'concepts/tgi.html',
  sglang:'concepts/sglang.html',
  gptq:'concepts/gptq.html',
  awq:'concepts/awq.html',
  bnb:'concepts/bitsandbytes.html',
  wandb:'concepts/wandb.html',
  langfuse:'concepts/langfuse.html',
  deepeval:'concepts/deepeval.html',
  trulens:'concepts/trulens.html',
  whisper:'concepts/whisper.html',
  // batch 18 — llms(5) + applications/coding(3) + multimodal(2)
  llama3:'concepts/llama3.html',
  mistral:'concepts/mistral.html',
  gemini15:'concepts/gemini15.html',
  context_window:'concepts/context-window.html',
  phi3:'concepts/phi3.html',
  cursor:'concepts/cursor.html',
  copilot:'concepts/copilot.html',
  aider:'concepts/aider.html',
  stable_diff:'concepts/stable-diffusion.html',
  gpt4v:'concepts/gpt4v.html',
  // batch 19 — chunking(5) + sysdesign(3) + dev tools(2)
  fixed_size:'concepts/fixed-size-chunking.html',
  sentence_window:'concepts/sentence-window.html',
  semantic_chunking:'concepts/semantic-chunking.html',
  parent_child:'concepts/parent-child-chunking.html',
  late_chunking:'concepts/late-chunking.html',
  rag_vs_ft:'concepts/rag-vs-finetuning.html',
  model_select:'concepts/model-selection.html',
  latency_budget:'concepts/latency-budget.html',
  streamlit:'concepts/streamlit.html',
  gradio:'concepts/gradio.html',
  // batch 20 — prod_eng(3) + transformers(4) + eval(3)
  sync_async:'concepts/sync-async-serving.html',
  circuit_breaker:'concepts/circuit-breaker.html',
  batch_exec:'concepts/batch-execution.html',
  cross_attn:'concepts/cross-attention.html',
  gqa:'concepts/gqa.html',
  spec_dec:'concepts/speculative-decoding.html',
  paged_attn:'concepts/paged-attention.html',
  ...
  // batch 22 — finetuning(4) + custom(3) + multimodal(3)
  prefix_tuning:'concepts/prefix-tuning.html',
  ia3:'concepts/ia3.html',
  axolotl:'concepts/axolotl.html',
  llama_factory:'concepts/llama-factory.html',
  dvc:'concepts/dvc.html',
  hf_hub:'concepts/hf-hub.html',
  openai_compat:'concepts/openai-compat-api.html',
  llava:'concepts/llava.html',
  dalle3:'concepts/dalle3.html',
  flux:'concepts/flux.html',
  // batch 23 — sysdesign(5) + infra(3) + multimodal(2)
  agent_vs_pipe:'concepts/agent-vs-pipeline.html',
  build_vs_buy:'concepts/build-vs-buy.html',
  eval_design:'concepts/eval-design.html',
  golden_sets:'concepts/golden-test-sets.html',
  prompt_regression:'concepts/prompt-regression.html',
  llm_router:'concepts/llm-router.html',
  semantic_cache:'concepts/semantic-cache.html',
  openrouter:'concepts/openrouter.html',
  paligemma:'concepts/paligemma.html',
  qwen_vl:'concepts/qwen-vl.html',
  // batch 24 — sysdesign(7) + infra(3)
  online_eval:'concepts/online-eval.html',
  fallback_chains:'concepts/fallback-chains.html',
  system_eval:'concepts/system-eval.html',
  test_time_compute:'concepts/test-time-compute.html',
  long_ctx_impact:'concepts/long-ctx-impact.html',
  multimodal_native:'concepts/multimodal-native.html',
  distillation_ft:'concepts/distillation.html',
  batch_api:'concepts/batch-api.html',
  constrained_decoding:'concepts/constrained-decoding.html',
  nvidia_gpu:'concepts/nvidia-gpu.html',
  // batch 25 — prod_eng(8) + finetuning(2)
  timeout_budget:'concepts/timeout-budget.html',
  cost_routing:'concepts/cost-routing.html',
  budget_guard:'concepts/budget-guards.html',
  session_state:'concepts/session-state.html',
  checkpointing:'concepts/checkpointing.html',
  audit_trail:'concepts/audit-trail.html',
  approval_gate:'concepts/approval-gates.html',
  override_flow:'concepts/override-escalation.html',
  rlaif:'concepts/rlaif.html',
  data_flywheel:'concepts/data-flywheel.html',
  // batch 26 — applications(10)
  haystack:'concepts/haystack.html',
  cognee:'concepts/cognee.html',
  instructor_app:'concepts/instructor.html',
  outlines_app:'concepts/outlines.html',
  marvin:'concepts/marvin.html',
  text2sql:'concepts/text2sql.html',
  vanna:'concepts/vanna.html',
  ...
  // batch 28 — data_eng(2) + applications(1) + infra(5) + multimodal(2)
  data_contracts:'concepts/data-contracts.html',
  data_lineage:'concepts/data-lineage.html',
  elevenlabs:'concepts/elevenlabs.html',
  amd_gpu:'concepts/amd-rocm.html',
  apple_mlx:'concepts/apple-mlx.html',
  hf_spaces:'concepts/hf-spaces.html',
  modal_labs:'concepts/modal-labs.html',
  replicate:'concepts/replicate.html',
  diffusion:'concepts/diffusion-models.html',
  tts_models:'concepts/tts-models.html',
  // batch 29 — multimodal(3) FINAL
  audiocraft:'concepts/audiocraft.html',
